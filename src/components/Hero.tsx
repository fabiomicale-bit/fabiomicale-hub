  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        {/* Headline */}
        <h1 className="animate-fade-in-up delay-100 text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-white mb-6">
          Hai più di 40 anni.{" "}
          <br className="hidden sm:block" />
          <span className="gradient-text">L&apos;AI sta cambiando tutto.</span>
          <br />
          Puoi restare indietro —{" "}
          <br className="hidden sm:block" />o imparare a usarla per{" "}
          <span className="gradient-text">reinventarti.</span>
        </h1>

        {/* Subtitle */}
        <p className="animate-fade-in-up delay-200 text-lg sm:text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto mb-10">
        ...
        {/* Social proof */}
        <div className="animate-fade-in-up delay-400 mt-16 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 text-slate-500 text-sm">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-bold text-white">10+</span>
            <span>anni di coaching</span>
          </div>
