/**
 * ARCHIVIO LEGACY — Il Libro (/il-libro)
 *
 * Sezioni rimosse durante il refactoring Fase 4 (refactor/3-passi-positioning).
 * La rotta /il-libro è stata rinominata in /successo-in-3-passi.
 * Redirect 301 in next.config.ts copre la migrazione.
 * NON importare questo file in produzione.
 *
 * Sezioni archiviate:
 * 1. Hero con copertina libro (next/image, /fabio libro.jpg)
 * 2. Focus Cards — 3 card: Il Protocollo, Dossier Reali, Operatività
 * 3. I 3 Passi — grid con cerchi e citazioni
 * 4. Per chi è — 4 bullet + CTA email
 * 5. Edizione 2017 — sezione storica con link Amazon
 * 6. CTA Finale — charcoal con link Amazon 2017 + /accademia
 */
...
// ─────────────────────────────────────────────────────────────────────────────
// 1. HERO con copertina
//    Cover: /fabio libro.jpg (ora BookFeature usa /copertina-libro.png)
// ─────────────────────────────────────────────────────────────────────────────
export function IlLibroHeroLegacy() {
  return (
...
// ─────────────────────────────────────────────────────────────────────────────
// 2. FOCUS CARDS — Il Protocollo, Dossier Reali, Operatività
// ─────────────────────────────────────────────────────────────────────────────
export function IlLibroFocusCardsLegacy() {
  return (
...
// ─────────────────────────────────────────────────────────────────────────────
// 3. I 3 PASSI — grid con cerchi numerici e citazioni
// ─────────────────────────────────────────────────────────────────────────────
const passi = [
  { numero: "I", titolo: "Ferma il Caos", citazione: "Prima di correre nella direzione giusta, devi accettare di aver corso in quella sbagliata." },
  { numero: "II", titolo: "Rimetti Struttura", citazione: "L'identità precede la direzione. Senza asset, sei solo un passeggero della tua vita." },
  { numero: "III", titolo: "Dominio Sistemico", citazione: "La libertà non è l'assenza di regole, ma la presenza di un sistema che le gestisce per te." },
];

export function IlLibro3PassiLegacy() {
  return (
...
// 4. "PER CHI È" — 4 bullet + CTA email
// ─────────────────────────────────────────────────────────────────────────────
export function IlLibroPerChiELegacy() {
  return (
...
// ─────────────────────────────────────────────────────────────────────────────
// 5. EDIZIONE 2017 — sezione storica
// ─────────────────────────────────────────────────────────────────────────────
export function IlLibroEdizione2017Legacy() {
  return (
...
// ─────────────────────────────────────────────────────────────────────────────
// 6. CTA FINALE — charcoal con Amazon 2017 + /accademia
// ─────────────────────────────────────────────────────────────────────────────
export function IlLibroCTAFinaleLegacy() {
  return (
