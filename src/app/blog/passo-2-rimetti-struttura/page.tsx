...
const jsonLd = {
  ...
  description: "Articoli sul Passo 2 del Metodo Successo in 3 Passi",
  url: "https://www.fabiomicale.com/blog/passo-2-rimetti-struttura",
  isPartOf: { "@type": "WebSite", url: "https://www.fabiomicale.com" },
};

export default function Passo2Page() {
  const allPosts = getPostsByStep(2);
      ...
      <section className="relative pt-44 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-light leading-[1.05] tracking-tight mb-8 font-serif text-hub-ink">
            Rimetti <span className="italic text-hub-gold">Struttura.</span>
          </h1>
