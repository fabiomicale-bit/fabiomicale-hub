...
export default function ShareBar({ titolo, slug }: Props) {
  ...
  const btnClass =
    "text-xs px-3 py-1.5 rounded-full border border-hub-border text-hub-ink-muted hover:text-hub-ink hover:border-hub-ink/20 transition-all duration-200 cursor-pointer";
