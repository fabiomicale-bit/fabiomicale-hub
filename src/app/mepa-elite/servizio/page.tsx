...
export const metadata: Metadata = {
  title: "Il Servizio MePA Elite | Gestione Appalti Pubblici — Fabio Micale",
  ...
  const fasi = [
    {
      ...
      desc: "Analizziamo il tuo codice ATECO e ti abilitiamo ai bandi MePA corretti per massimizzare le opportunità di vendita.",
      num: "01"
    },
    {
    ...
    },
    {
      ...
      desc: "Ti assistiamo nella fase di post-aggiudicazione e monitoriamo i flussi di pagamento per garantire la liquidità aziendale.",
      num: "04"
    }
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative pt-60 pb-32 px-6 overflow-hidden bg-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto font-light leading-relaxed mb-16">
            Non vendiamo consulenza, vendiamo risultati. Ci occupiamo di tutta la complessità burocratica per lasciarti libero di produrre valore.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
            <div>
              ...
              <p className="text-lg text-slate-500 font-light leading-relaxed italic">
                Ogni passaggio è codificato per azzerare il rischio di esclusione e massimizzare le probabilità di successo.
              </p>
            </div>
      ...
      <section className="py-40 px-6 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto text-center">
          <div className="badge-pa bg-brand-blue text-white mx-auto mb-12">DISPONIBILITÀ LIMITATA</div>
