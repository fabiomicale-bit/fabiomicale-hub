        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            <p className="text-xl text-slate-500 font-light leading-relaxed mb-12 max-w-md">
               Ogni azienda è diversa. Compila il modulo per una valutazione gratuita di fattibilità entro 24 ore.
            </p>
            ...
            <div className="bg-brand-blue p-10 rounded-[40px] text-white relative overflow-hidden shadow-2xl">
               ...
               <div className="relative z-10">
                  ...
                  <p className="text-blue-100 text-sm font-light mb-8 italic opacity-80">
                     Scopri quali sono i bandi "sotto soglia" più semplici da vincere anche se sei da solo. Scaricala compilando il form a lato.
                  </p>
             ...
             {success ? (
               ...
               <>
                 ...
                 <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    ...
                    >
                       {loading ? "Invio in corso..." : "Invia Candidatura e Scarica PDF →"}
                    </button>
                 </form>
               </>
             )}
