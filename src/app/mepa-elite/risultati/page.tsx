      ...
      <section className="mt-20 text-center">
         <div className="max-w-2xl mx-auto px-4">
            ...
            <p className="text-slate-500 mb-10 font-light">
               La tua azienda ha le stesse potenzialità di queste realtà. Smettila di guardare gli altri vincere e prendi la tua fetta di mercato.
            </p>
            <a href="/mepa-elite/contatti" className="bg-brand-blue text-white px-12 py-6 rounded-2xl text-xs font-black uppercase tracking-[0.2em] shadow-2xl hover:bg-blue-700 transition-all inline-block hover:scale-105">Inizia Ora →</a>
         </div>
      </section>
    </div>
  );
