...
export default function ChiSiamoPage() {
  return (
    <div className="bg-white">
      {/* ðŸ™ï¸ INTRO: LA RETE D'ELITE */}
      <section className="pt-40 pb-24 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-24">
           <span className="text-brand-blue font-black text-xs tracking-[0.4em] uppercase mb-6 block italic">L'AutoritÃ  della Squadra</span>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-slate-500 font-light leading-relaxed">
               <p>
                  MEPA Elite non Ã¨ il lavoro di un singolo professionista, ma la sintesi di una **Rete di Specialisti** coordinati da Fabio Micale. Abbiamo capito che per vincere davvero negli appalti pubblici, non serve un "esperto generico", ma una squadra che copra ogni centimetro del processo.
               </p>
               <p>
         ...
         <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-10">
               {[
                 ...
                 { 
                   role: "Esperto ConformitÃ  Normativa", 
