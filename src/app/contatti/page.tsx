    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pb-20 pt-16 px-6 bg-white">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-4 text-[#555555] leading-relaxed text-[1.05rem]">
            <p>
              Sono <span className="text-[#111111] font-medium">Fabio Micale</span> — coach, imprenditore e autore
      ...
      <section className="py-16 px-6 bg-[#F7F7F7]">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-[#E5E5E5] rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 rounded-lg bg-[#E8F5E9] border border-[#E5E5E5] flex items-center justify-center">
                <svg className="w-4 h-4 text-[#2E7D32]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h2 className="text-[#111111] font-bold text-xl">Scrivimi se...</h2>
            </div>
            <ul className="space-y-4">
              {scrivimiSe.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#E8F5E9] border border-[#E5E5E5] flex items-center justify-center shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#2E7D32]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <span className="text-[#555555] leading-relaxed text-[0.95rem]">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-white border border-[#E5E5E5] rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-[#111111] font-bold text-xl">Non scrivermi se...</h2>
            </div>
            <ul className="space-y-4">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#555555] leading-relaxed text-[1.05rem] mb-10">
            Il modo più diretto per contattarmi è via email.{" "}
            <span className="text-[#111111]">Rispondo personalmente a ogni messaggio entro 48 ore.</span>
          </p>
      ...
      <section className="pb-20 px-6 bg-white">
        <div className="max-w-xl mx-auto text-center">
          <p className="text-[#555555]/60 text-sm italic leading-relaxed">
