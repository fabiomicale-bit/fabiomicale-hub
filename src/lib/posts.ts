...
export const posts: Post[] = [
  // ── ARTICOLI RECENTI ──────────────────────────────────────────
  {
    ...
    contentHtml: `
<p>Hai più di 40 anni e stai pensando di cambiare lavoro. Non perché sei impulsivo, ma al contrario: ci pensi da mesi, forse da anni. Hai una posizione, uno stipendio, responsabilità. Ma qualcosa non torna più: il lavoro che fai ti chiede sempre più energia per risultati che senti sempre meno tuoi.</p>

<p>E ogni volta che il pensiero torna, si blocca nello stesso punto: «Ma come faccio? Dovrei ricominciare da zero.»</p>

<p>No. Non devi ricominciare da zero. E questa convinzione (ovvero che cambiare lavoro a 40 anni significhi buttare vent'anni di esperienza) è il primo errore da smontare, perché è quello che tiene ferme più persone di qualsiasi ostacolo reale.</p>
...
<p>Se sei nella fase in cui senti che qualcosa deve cambiare ma non sai ancora da dove partire, ti consiglio di leggere prima <a href="/blog/reinventarsi-dopo-i-40-metodo">la guida completa su come reinventarsi dopo i 40</a>: è la visione d'insieme. Questo articolo è il passo successivo, ossia lo strumento operativo.</p>

<h2>Perché «ricominciare da zero» è un falso problema</h2>

<p>La frase «dovrei ricominciare da zero» è la versione adulta di «è troppo tardi». Ha la stessa struttura: suona ragionevole, blocca l'azione, e si basa su un presupposto sbagliato, ovvero che le competenze siano legate al ruolo e non alla persona.</p>
...
<p>Compilare questa matrice richiede un'ora di lavoro onesto. Ma ti dà qualcosa che la maggior parte delle persone che vuole cambiare lavoro non ha: una mappa chiara di quello che porti con te. Non un'impressione, ma un inventario.</p>
...
<p>Cambiare lavoro a 40 anni senza un metodo è come ristrutturare una casa senza progetto: si demolisce qualcosa, si improvvisa, e si finisce con un cantiere aperto a tempo indefinito. Il metodo che propongo (e che uso nel <a href="/il-metodo">metodo Successo in 3 Passi</a>) prevede tre fasi precise, ciascuna con un risultato verificabile.</p>
...
<p>La transizione vera (ovvero il momento in cui cambi effettivamente lavoro) arriva solo quando hai: un margine economico sufficiente (almeno 6 mesi di spese coperte), una direzione testata con feedback reale, e un piano con date e condizioni di uscita definite. Senza questi tre elementi, non stai cambiando lavoro: stai scommettendo. E le scommesse, dopo i 40, hanno costi che non puoi ignorare.</p>

<h2>Il piano operativo a 30 giorni</h2>

<p>Trenta giorni non bastano per cambiare lavoro. Bastano per capire se la direzione che hai in mente regge e per smettere di pensarci senza fare niente. Ecco un piano concreto, con un'azione alla settimana.</p>
...
<p>Individua tre direzioni professionali realistiche dove le tue competenze trasferibili avrebbero valore. Non tre sogni, ma tre opzioni concrete, con domanda di mercato verificabile. Per ciascuna, trova una persona che già lavora in quel campo e chiedi una conversazione di 20 minuti: non per chiedere un lavoro, ma per capire come funziona davvero quel mondo.</p>
...
<p><strong>Dai 50 in su</strong> la transizione richiede un'attenzione maggiore al posizionamento. Il mercato del lavoro ha bias reali legati all'età, e negarli non serve. La strategia più efficace è aggirare il canale tradizionale (invio curriculum → selezione → colloquio) e costruire un posizionamento diretto: consulenza, collaborazione, progetto pilota, referral. In altre parole: non cercare un lavoro, ma fai in modo che il lavoro cerchi te, attraverso le relazioni e la reputazione costruite in vent'anni.</p>

<h2>Domande frequenti</h2>

<h3>Ho 40 anni e nessuna idea di cosa fare: da dove comincio?</h3>
<p>Dalla matrice delle competenze trasferibili che trovi in questo articolo. L'idea non deve arrivare prima dell'analisi, ma deve emergere da essa. Compila la matrice, identifica le tue competenze più forti, e cerca dove queste competenze hanno domanda. La direzione non si inventa: si costruisce sui dati.</p>
...
<p>Cambiare lavoro a 40 anni non richiede coraggio speciale. Richiede un metodo, ossia qualcosa che trasformi il pensiero ricorrente «dovrei cambiare» in una sequenza di azioni concrete, verificabili, a basso rischio.</p>
...
<p>Se vuoi la struttura completa (i tre passi per fermare il caos, rimettere struttura e mantenere il controllo), la trovi nel <a href="/il-metodo">metodo Successo in 3 Passi</a>.</p>
...
<section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
  ...
  <p class="mb-6 text-sm leading-relaxed text-hub-ink-muted">Questo articolo fa parte della playlist "Dal Blog al Video". Qui trovi la versione video dedicata alla differenza tra motivazione e struttura, e ai 4 elementi che rendono un progetto capace di avanzare anche nei giorni storti.</p>
  <div class="aspect-video overflow-hidden rounded-xl border border-hub-border bg-black">
    <iframe
      class="h-full w-full"
      src="https://www.youtube-nocookie.com/embed/HCHi7zXCO9Y"
      title="Dal Blog al Video — Il problema non è la motivazione. È la struttura | Fabio Micale"
      loading="lazy"
      allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      allowfullscreen
    ></iframe>
  </div>
  <p class="mt-4 text-sm"><a href="https://youtu.be/HCHi7zXCO9Y" target="_blank" rel="noopener noreferrer">Guarda il video su YouTube</a></p>
</section>
  `,
  },
  {
...
<section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
  <p class="mb-2 text-[10px] font-bold uppercase tracking-[0.25em] text-hub-gold">Dal Blog al Video</p>
  <h2 class="mb-3 font-serif text-3xl font-medium italic text-hub-ink">Guarda la versione video</h2>
  <p class="mb-6 text-sm leading-relaxed text-hub-ink-muted">Questo articolo fa parte della playlist "Dal Blog al Video". Qui trovi la versione video dedicata al sistema minimo per mantenere il controllo nei giorni in cui l'energia è bassa.</p>
  <div class="aspect-video overflow-hidden rounded-xl border border-hub-border bg-black">
    <iframe
      class="h-full w-full"
      src="https://www.youtube-nocookie.com/embed/HWKiXJH6lCM"
      title="Dal Blog al Video — Il sistema minimo per i giorni storti | Fabio Micale"
      loading="lazy"
      allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      allowfullscreen
    ></iframe>
  </div>
  <p class="mt-4 text-sm"><a href="https://youtu.be/HWKiXJH6lCM" target="_blank" rel="noopener noreferrer">Guarda il video su YouTube</a></p>
</section>
  `,
  },
  {
...
<section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
  <p class="mb-2 text-[10px] font-bold uppercase tracking-[0.25em] text-hub-gold">Dal Blog al Video</p>
  <h2 class="mb-3 font-serif text-3xl font-medium italic text-hub-ink">Guarda la versione video</h2>
  <p class="mb-6 text-sm leading-relaxed text-hub-ink-muted">Questo articolo fa parte della playlist "Dal Blog al Video". Qui trovi la versione video dedicata alla regola del rientro del Passo 3: come tornare in carreggiata senza ricominciare da zero.</p>
  <div class="aspect-video overflow-hidden rounded-xl border border-hub-border bg-black">
    <iframe
      class="h-full w-full"
      src="https://www.youtube-nocookie.com/embed/kKWakV8c94Q"
      title="Dal Blog al Video — Torna in Carreggiata | Fabio Micale"
      loading="lazy"
      allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      allowfullscreen
    ></iframe>
  </div>
  <p class="mt-4 text-sm"><a href="https://youtu.be/kKWakV8c94Q" target="_blank" rel="noopener noreferrer">Guarda il video su YouTube</a></p>
</section>
  `,
  },
  {
...
<section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
  ...
  },
  {
    ...
    dataISO: "2026-03-31",
    tempoLettura: "7 min",
    ogImage: "/blog/paura-obsolescenza-professionale-ai-real-photo.jpg",
    coverAlt: "Professionista con occhiali si massaggia le tempie davanti al laptop in un ufficio luminoso, segno di stanchezza e pressione lavorativa",
    excerpt:
    ...
    <section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
      <p class="mb-2 text-[10px] font-bold uppercase tracking-[0.25em] text-hub-gold">Dal Blog al Video</p>
      <h2 class="mb-3 font-serif text-3xl font-medium italic text-hub-ink">Guarda la versione video</h2>
      <p class="mb-6 text-sm leading-relaxed text-hub-ink-muted">Questo articolo fa parte della playlist "Dal Blog al Video". Qui trovi la versione video su questa stessa paura e su cosa farne davvero.</p>
      <div class="aspect-video overflow-hidden rounded-xl border border-hub-border bg-black">
        <iframe
          class="h-full w-full"
          src="https://www.youtube-nocookie.com/embed/88gr8j15BBk"
          title="Dal Blog al Video — Paura di essere tagliato fuori dall'AI? | Fabio Micale"
          loading="lazy"
          allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen
        ></iframe>
      </div>
      <p class="mt-4 text-sm"><a href="https://youtu.be/88gr8j15BBk" target="_blank" rel="noopener noreferrer">Guarda il video su YouTube</a></p>
    </section>
    `,
  },
  {
...
<div class="blog-cta">
...

  {
    ...
    dataISO: "2026-03-13",
    tempoLettura: "7 min",
    ogImage: "/blog/manifesto-sistemi-autonomi-real-photo.jpg",
    coverAlt: "Foglio con lista di cose da fare scritta a mano accanto a un calendario e una penna, primo piano",
    excerpt:
...
<section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
...

  {
    ...
    dataISO: "2026-02-28",
    tempoLettura: "4 min",
    ogImage: "/blog/sistemi-che-lavorano-per-te-real-photo.jpg",
    coverAlt: "Agenda planner aperta con to-do list scritta a mano e una penna, vista dall'alto",
    excerpt:
...
<p>Poi <a href="/newsletter">iscriviti alla newsletter per altri strumenti pratici ogni settimana</a>. Se vuoi inserire l'AI dentro un metodo più ampio, <a href="/estratto">inizia dall'estratto gratuito di Successo in 3 Passi</a>.</p>
    ...
    <section class="not-prose my-12 rounded-2xl border border-hub-border bg-hub-white p-6 shadow-sm">
      <p class="mb-2 text-[10px] font-bold uppercase tracking-[0.25em] text-hub-gold">Dal Blog al Video</p>
      <h2 class="mb-3 font-serif text-3xl font-medium italic text-hub-ink">Guarda la versione video</h2>
      <p class="mb-6 text-sm leading-relaxed text-hub-ink-muted">Questo articolo fa parte della playlist "Dal Blog al Video". Qui trovi la versione video su come usare davvero Claude AI al lavoro.</p>
      <div class="aspect-video overflow-hidden rounded-xl border border-hub-border bg-black">
        <iframe
          class="h-full w-full"
          src="https://www.youtube-nocookie.com/embed/hXotjVQVVuU"
          title="Dal Blog al Video — Claude AI: come usarlo davvero al lavoro | Fabio Micale"
          loading="lazy"
          allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen
        ></iframe>
      </div>
      <p class="mt-4 text-sm"><a href="https://youtu.be/hXotjVQVVuU" target="_blank" rel="noopener noreferrer">Guarda il video su YouTube</a></p>
    </section>
    `,
  },
  {
