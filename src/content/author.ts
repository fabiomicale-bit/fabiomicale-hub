export const author = {
  ...
  fullBio: [
    ...
    "Oggi affianca imprenditori e professionisti Over 40 che vogliono reinventarsi nell'era dell'intelligenza artificiale, con il metodo, gli strumenti e la guida di chi ha fatto lo stesso percorso. Risponde personalmente alle email. Senza assistenti, senza centralini.",
    "Ha pubblicato la prima edizione di Successo in 3 Passi nel 2017. L'edizione 2026 è una riscrittura completa, basata su tutto quello che ha imparato nel frattempo.",
  ],
  contacts: {
    main: "info@fabiomicale.com",
    book: "libro.successointrepassi@fabiomicale.com",
    site: "fabiomicale.com",
  },
} as const;
