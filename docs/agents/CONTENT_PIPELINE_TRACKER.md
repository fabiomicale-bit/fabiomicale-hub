...
| `claude-ai-come-usarlo-al-lavoro` | LIVE | **SI — https://youtu.be/hXotjVQVVuU** (unlisted) | **SI (embed + schema VideoObject preparati, non deployati)** | `DA_VERIFICARE` | `DA_VERIFICARE` | 2026-08-13 | Pubblicato 2026-08-13 su YouTube (upload manuale di Fabio). Embed e voce `videoMetadata.ts` committati in locale (`0e87ffa`), **non pushati/deployati**: in attesa di autorizzazione esplicita al push. Eccezione nota: sigla intro senza audio, accettata solo per questo video. Sottotitoli: YouTube Automatic Captions (Italiano), SRT tecnico non caricato. Pacchetto completo in `docs/agents/work/video-claude-ai-come-usarlo-al-lavoro/`. |
| `paura-obsolescenza-professionale-ai` | LIVE | **SI — https://youtu.be/88gr8j15BBk** | **SI (embed + schema VideoObject preparati, non deployati)** | `DA_VERIFICARE` | `DA_VERIFICARE` | 2026-08-16 | Pubblicato 2026-08-16 su YouTube (upload manuale di Fabio), verificato reale/pubblico via yt-dlp (durata 5:43 = 343s, coerente col render approvato). Embed e voce `videoMetadata.ts` modificati in locale, **non committati/pushati/deployati**: in attesa di autorizzazione esplicita. Appunto non bloccante di Fabio: pronuncia TTS di "ce la farò" migliorabile, regola QA pronuncia permanente registrata in `agente-video-mesarender-production.md`. Sottotitoli: SRT tecnico non caricato (policy vigente), lingua video da impostare Italiano per i sottotitoli automatici. Pacchetto completo in `docs/agents/work/video-paura-obsolescenza-professionale-ai/`. |
